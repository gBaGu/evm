...
pub trait PrecompileSet<'precompile> {
...
impl<'precompile> PrecompileSet<'precompile> for () {
	fn execute(
		&self,
		_: H160,
		_: &[u8],
...
impl<'precompile> PrecompileSet<'precompile> for Precompile<'precompile> {
	fn execute(
		&self,
		address: H160,
		input: &[u8],
...
impl<'config, 'precompiles, S: StackState<'config>, P: PrecompileSet<'precompiles>> Handler
